...
local menu = "/home/heartofgold/.config/rofi/launchers/type-7/launcher.sh || pkill rofi"
local screenshot =
	'grim -g "$(slurp)" - | wl-copy && wl-paste > ~/Pictures/Screenshots/Screenshot-$(date +%F_%T).png && notify-send "Taken an area screenshot" "Saved in ~/Pictures/Screenshots/Screenshot-$(date +%F_%T).png"'
...
hl.on("hyprland.start", function()
	hl.exec_cmd("hyprpaper & hyprpanel")
end)
...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("hyprpanel r"))
